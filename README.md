<p align="center">
  <img src="#" width="230" alt="Know Thy Self Logo">
</p>

<!--  -->
<div align="center">
  <b>Know Thy Self</b>
  <b>Gather all of your personal data from around the web and learn something about yourself.</b>
</div>
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/rasulkireev/knowthyself)
...
How you are going to expose the backend container is up to you. I usually do it via Nginx Reverse Proxy with `http://knowthyself-backend-1:80` UPSTREAM_HTTP_ADDRESS.
